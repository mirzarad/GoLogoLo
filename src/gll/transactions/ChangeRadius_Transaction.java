...
public class ChangeRadius_Transaction implements jTPS_Transaction {
    ...
    public ChangeRadius_Transaction(GoLogoLoApp initapp,Shape initnode) {
        app = initapp;
        EditedNode = initnode;
    ...
    public void doTransaction() {
        if(Changedfill==null){
            double slidervalue = ((Slider)app.getGUIModule().getGUINode(GLL_RADIUS_SLIDER)).getValue()*0.2;
            RadialGradient grad = new RadialGradient(angle,distance,centerX,centerY,slidervalue,true,method,stops);
